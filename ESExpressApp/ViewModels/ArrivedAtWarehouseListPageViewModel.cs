...
{
	public partial class ArrivedAtWarehouseListPageViewModel : BaseViewModel
    {
        ...
        public ArrivedAtWarehouseListPageViewModel(ILocalizationResourceManager resourceManager)
        {
        ...
        public void LoadPersonWaybillList(int start)
        {
            ...
            var dicParameters = new Dictionary<string, string>
                    {
                      {"manageType",ProfileMenuStatus.Arrivedatwarehouse.ToString().ToLower()},
