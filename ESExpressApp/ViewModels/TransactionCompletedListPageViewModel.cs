...
{
	public partial class TransactionCompletedListPageViewModel : BaseViewModel
    {
        ...
        public TransactionCompletedListPageViewModel(ILocalizationResourceManager resourceManager)
        {
        ...
        public void LoadPersonWaybillList(int start)
        {
            ...
            var dicParameters = new Dictionary<string, string>
                    {
                      {"manageType",ProfileMenuStatus.TransactionCompleted.ToString().ToLower()},
